...
for label in {1,3,5,7}; do
	...
	python checkerboard_generate.py --input_label ${labelDir}/${label}/atlasSeg_final.nii.gz --grid_size 4 --view 0 --output_cb ${cbDir}/${label}/atlasSeg_final.nii.gz --num_colors 256

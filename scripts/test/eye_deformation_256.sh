...
workingDir="/nfs/masi/saundam1/outputs/eye_atlas/checkerboard_256/deformation"
...
for label in {1,3,5,7}; do
	...
	python checkerboard_generate.py --input_label ${atlasDir}/${label}/atlasSeg_final.nii.gz --grid_size 4 --view 0 --output_cb ${cbDir}/${label}/atlasSeg_final.nii.gz --num_colors 255
	...
	for subject in {10730_20070517_MR_8,11156_20321114_MR_5,11298_19920723_MR_9,11441_19921123_MR_1,11447_20030427_MR_1}; do
		...
		antsApplyTransforms -d 3 -i ${cbDir}/${label}/atlasSeg_final.nii.gz -r ${atlasDir}/${label}/atlasSeg_final.nii.gz -o ${inputDir}/${label}/atlasSeg_final.nii.gz -n NearestNeighbor -t [$affine, 1] -t $invWarp 

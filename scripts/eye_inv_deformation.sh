...
for label in {1,3}; do
	...
	for subject in {10730_20070517_MR_8,11447_20030427_MR_1}; do
		...
		antsApplyTransforms -d 3 -i ${cbDir}/${label}/${subject}_T2WFLAIR.nii.gz -r ${labelDir}/$subject/$label/${subject}_T2WFLAIR.nii.gz -o ${inputDir}/${label}/${subject}_T2WFLAIR.nii.gz -n NearestNeighbor -t [$affine,1] -t $invWarp  
